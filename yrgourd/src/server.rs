...
impl Server {
    ...
    pub fn respond_handshake(
        ...
        self.protocol.encrypt(b"server-commitment-point", &mut sig_i);
        ...
        let mut sig_s = s.to_bytes();
        self.protocol.encrypt(b"server-proof-scalar", &mut sig_s);
        ...
        Some((Connected::new(&self.protocol), HandshakeResponse { sig_i, sig_s }))
    }
}
